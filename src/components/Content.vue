<template lang="pug">
  .content
    .message
      .message-heading
        h2 Lets get Mt. Evans renamed to Black Kettle Mountain
        p
        ...
        | Colorado's legislature officially renamed the peak in honor of John Evans,
        | second governor of the Colorado Territory from 1862 to 1865." -
        |
